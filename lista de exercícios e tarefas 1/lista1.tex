...
\usepackage{fvextra, csquotes} %fvextra to avoid warning?
...
% Misc
\usepackage[outputdir=.aux/build]{minted}
\usepackage{luacolor}
...
\title{Física Matemática II\\Primeira Lista de Exercícios e Tarefas}
